...
## Description
This is a C programming language that aims to teach about what a binary tree is, the different traversal methods to go through a binary tree and the different types of binary trees (complete, full, perfect and balanced).
